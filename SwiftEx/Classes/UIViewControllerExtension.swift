...
public extension UIViewController {
    ...
    public func removeTitleFromBacK() {
        self.navigationItem.leftBarButtonItem = UIBarButtonItem(title: "<", style: .Plain, target: nil, action: nil)
    }

    public func displayContentController(vc: UIViewController) {
    ...
    public func displayContentControllerNavBar(vc: UIViewController) {
        self.addChildViewController(vc)
    ...
    public func displayContentControllerInView(vc: UIViewController, v: UIView) {
        self.addChildViewController(vc)
    ...
    public func displayContentControllerInViewAnimated(vc: UIViewController, v: UIView) {
        self.addChildViewController(vc)
        vc.view.frame = v.frame
        vc.view.autoresizingMask = [UIViewAutoresizing.FlexibleHeight, UIViewAutoresizing.FlexibleWidth]
        v.addSubview(vc.view)
    ...
    public func cycleViewController (oldViewController: UIViewController, newViewController: UIViewController, onComplete:(() -> Void)?) {
