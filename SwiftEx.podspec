...
s.name             = 'SwiftEx'
s.version          = '0.1.0'
s.summary          = 'SwiftEx collection of extensions'
...
s.homepage         = 'https://github.com/sucrewar/SwiftEx'
# s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
s.license          = { :type => 'MIT', :file => 'LICENSE' }
s.author           = { 'sucrewar' => 'sucrewar10@gmail.com' }
s.source           = { :git => 'https://github.com/sucrewar/SwiftEx.git', :tag => s.version.to_s }
